...
- [x] 02-04-PLAN.md — Update CLAUDE.md with the Gap 3 outcome + L2 lambda documentation correction
...
- [x] 03-01-PLAN.md — Core paraconsistent module: feature_eta_squared()/feature_lambda()/paraconsistent_select() with capped relaxation + fallback (PARA-01, PARA-02)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03-02-PLAN.md — Thread selection into mode_train_ex()'s fold/vowel loop (Master+Expert) + refactor predict_hierarchical_late_fusion() into the single source of truth (PARA-03, PARA-04)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03-03-PLAN.md — write_gap1_report() + write_gap_adoption_status() + mode_paraconsistent_ab() CLI orchestration (PARA-05, CROSS-01, CROSS-02)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 03-04-PLAN.md — Execute the real paraconsistent-ab A/B run and verify the produced report (PARA-05)
